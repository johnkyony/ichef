...
var map = {
	...
	"./pages/recipe-create/recipe-create.module": [
		"./src/app/pages/recipe-create/recipe-create.module.ts",
		"pages-recipe-create-recipe-create-module"
	],
	"./pages/recipes-details/recipes-details.module": [
		"./src/app/pages/recipes-details/recipes-details.module.ts",
		"pages-recipes-details-recipes-details-module"
	],
	"./pages/recipes-list/recipes-list.module": [
...
module.exports = __webpack_require__(/*! /home/jwalkr/nodeProjects/ionicProjects/ichef/src/main.ts */"./src/main.ts");
